...
public class ScriptableStats : ScriptableObject
{
    ...
    [Tooltip("Amount of available jumps")] public int AvailableJumpsFromWall = 1;

    [Header("WALL JUMP")] [Tooltip("The horizontal velocity applied when wall jumping")]
    ...
    [Header("Gravity")] [Tooltip("Deactivate gravity")]
