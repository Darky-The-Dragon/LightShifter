...
namespace Michsky.UI.Heat
{
    ...
    {
        [Header("Resources")] public TMP_InputField inputText;

        public Animator inputFieldAnimator;

        [Header("Settings")] public bool processSubmit;
        ...
        // Helpers
        private readonly float cachedStateLength = 0.25f;
        ...
        private void Update()
        {
            if (!processSubmit || string.IsNullOrEmpty(inputText.text) ||
                EventSystem.current.currentSelectedGameObject != inputText.gameObject) return;
