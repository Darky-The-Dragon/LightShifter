...
namespace Michsky.UI.Heat
{
    ...
    public class UIManagerText : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (UIManagerAsset.enableDynamicUpdate) UpdateText();
        }
        ...
        private void UpdateText()
        {
            ...
            else
            {
                if (colorType == ColorType.Primary)
                    objText.color = new Color(UIManagerAsset.primaryColor.r, UIManagerAsset.primaryColor.g,
                        UIManagerAsset.primaryColor.b, objText.color.a);
                else if (colorType == ColorType.Secondary)
                    objText.color = new Color(UIManagerAsset.secondaryColor.r, UIManagerAsset.secondaryColor.g,
                        UIManagerAsset.secondaryColor.b, objText.color.a);
                else if (colorType == ColorType.Accent)
                    objText.color = new Color(UIManagerAsset.accentColor.r, UIManagerAsset.accentColor.g,
                        UIManagerAsset.accentColor.b, objText.color.a);
                else if (colorType == ColorType.AccentMatch)
                    objText.color = new Color(UIManagerAsset.accentColorInvert.r, UIManagerAsset.accentColorInvert.g,
                        UIManagerAsset.accentColorInvert.b, objText.color.a);
                else if (colorType == ColorType.Negative)
                    objText.color = new Color(UIManagerAsset.negativeColor.r, UIManagerAsset.negativeColor.g,
                        UIManagerAsset.negativeColor.b, objText.color.a);
                else if (colorType == ColorType.Background)
                    objText.color = new Color(UIManagerAsset.backgroundColor.r, UIManagerAsset.backgroundColor.g,
                        UIManagerAsset.backgroundColor.b, objText.color.a);
            }
        }
    }
}