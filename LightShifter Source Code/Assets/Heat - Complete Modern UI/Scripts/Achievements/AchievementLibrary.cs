...
namespace Michsky.UI.Heat
{
    ...
    public class AchievementLibrary : ScriptableObject
    {
        ...
        [Space(10)] public List<AchievementItem> achievements = new();
        ...
        public class AchievementItem
        {
            ...
            [Header("Hidden")] public bool isHidden;
            ...
            [Header("Localization")] [Tooltip("If you're not using localization, you can leave this field blank.")]
