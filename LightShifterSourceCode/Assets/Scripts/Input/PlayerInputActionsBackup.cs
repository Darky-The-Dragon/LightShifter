...
//     version 1.11.2
//     from Assets/Scripts/Input/PlayerInputActionsBackup.inputactions
//
...
{
    public partial class @PlayerInputActionsBackup: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @PlayerInputActionsBackup()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""PlayerInputActionsBackup"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ""controlSchemes"": [
        ...
        ~@PlayerInputActionsBackup()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerInputActionsBackup.Player.Disable() has not been called.");
        }
        ...
        {
            private @PlayerInputActionsBackup m_Wrapper;
            public PlayerActions(@PlayerInputActionsBackup wrapper) { m_Wrapper = wrapper; }
