...
namespace Michsky.UI.Heat
{
    ...
    public class ShopButtonManager : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler,
        ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        // Events
        public UnityEvent onPurchaseClick = new();
        ...
        private void Initialize()
        {
            ...
            if (useLocalization && !useCustomContent)
            {
                ...
                else
                {
                    ...
                    {
                        var titleLoc = titleObj.gameObject.GetComponent<LocalizedObject>();
                        if (titleLoc != null)
                        {
                    ...
                    {
                        var descLoc = descriptionObj.gameObject.GetComponent<LocalizedObject>();
                        if (descLoc != null)
                        {
        ...
        public void UpdateUI()
        {
            ...
            {
                priceObj.transform.parent.gameObject.SetActive(false);
            }
            else if (enablePrice && priceIconObj != null)
            {
                if (priceObj != null)
                {
                    priceObj.transform.parent.gameObject.SetActive(true);
