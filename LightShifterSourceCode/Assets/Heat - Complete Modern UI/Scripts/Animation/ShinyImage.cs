...
namespace Michsky.UI.Heat
{
    ...
    {
        [Header("Resources")] [SerializeField] private RectTransform targetRect;

        [SerializeField] private RectTransform parentRect;

        [Header("Animation")] [SerializeField] [Range(0, 4)]
        ...
        {
            float elapsedTime = 0;
            var startPos = new Vector2(-parentRect.sizeDelta.x, targetRect.anchoredPosition.y);
            var endPos = new Vector2(+parentRect.sizeDelta.x, targetRect.anchoredPosition.y);
            ...
            while (targetRect.anchoredPosition.x < endPos.x - 0.1f)
            {
                ...
                targetRect.anchoredPosition =
                    new Vector2(Mathf.Lerp(startPos.x, endPos.x, animationCurve.Evaluate(elapsedTime * animationSpeed)),
