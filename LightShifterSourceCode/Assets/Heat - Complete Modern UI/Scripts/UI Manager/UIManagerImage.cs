        ...
        private void UpdateImage()
        {
            ...
            else
            {
                if (colorType == ColorType.Primary)
                    objImage.color = new Color(UIManagerAsset.primaryColor.r, UIManagerAsset.primaryColor.g,
                        UIManagerAsset.primaryColor.b, objImage.color.a);
                else if (colorType == ColorType.Secondary)
                    objImage.color = new Color(UIManagerAsset.secondaryColor.r, UIManagerAsset.secondaryColor.g,
                        UIManagerAsset.secondaryColor.b, objImage.color.a);
                else if (colorType == ColorType.Accent)
                    objImage.color = new Color(UIManagerAsset.accentColor.r, UIManagerAsset.accentColor.g,
                        UIManagerAsset.accentColor.b, objImage.color.a);
                else if (colorType == ColorType.AccentMatch)
                    objImage.color = new Color(UIManagerAsset.accentColorInvert.r, UIManagerAsset.accentColorInvert.g,
                        UIManagerAsset.accentColorInvert.b, objImage.color.a);
                else if (colorType == ColorType.Negative)
                    objImage.color = new Color(UIManagerAsset.negativeColor.r, UIManagerAsset.negativeColor.g,
                        UIManagerAsset.negativeColor.b, objImage.color.a);
                else if (colorType == ColorType.Background)
                    objImage.color = new Color(UIManagerAsset.backgroundColor.r, UIManagerAsset.backgroundColor.g,
                        UIManagerAsset.backgroundColor.b, objImage.color.a);
            }
        }
    }
}