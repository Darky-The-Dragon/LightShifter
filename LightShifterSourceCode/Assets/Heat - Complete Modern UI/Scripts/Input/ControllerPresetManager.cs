...
{
    [CreateAssetMenu(fileName = "New Controller Preset Manager",
        menuName = "Heat UI/Controller/New Controller Preset Manager")]
    public class ControllerPresetManager : ScriptableObject
    {
        ...
        public List<ControllerPreset> customPresets = new();
    }
}