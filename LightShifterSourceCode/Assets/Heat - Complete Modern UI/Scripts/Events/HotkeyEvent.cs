...
namespace Michsky.UI.Heat
{
    ...
    public class HotkeyEvent : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        // Events
        public UnityEvent onHotkeyPress = new();
        ...
        private void Initialize()
        {
            ...
            if (useSounds)
                ...
                {
                    UIManagerAudio.instance.audioSource.PlayOneShot(UIManagerAudio.instance.UIManagerAsset
                        .clickSound);
                });
        ...
        public void UpdateUI()
        {
            ...
            if (hotkeyType == HotkeyType.Dynamic)
            {
                ...
                for (var i = 0; i < controllerPreset.items.Count; i++)
