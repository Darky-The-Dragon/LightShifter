...
namespace Michsky.UI.Heat
{
    ...
    {
        [Header("Resources")] public SettingsDescriptionManager manager;

        public SettingsElement element;

        [Header("Content")] [SerializeField] private Sprite cover;
        ...
        public void UpdateManager()
        {
            ...
            if (manager.localizedObject != null && manager.useLocalization && !string.IsNullOrEmpty(titleKey) &&
                !string.IsNullOrEmpty(descriptionKey))
                manager.UpdateUI(manager.localizedObject.GetKeyOutput(titleKey),
                    manager.localizedObject.GetKeyOutput(descriptionKey), cover);
